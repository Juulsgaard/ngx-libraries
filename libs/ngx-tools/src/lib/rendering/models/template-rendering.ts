...
export abstract class TemplateRendering<T extends object = object> {
...
export class StaticTemplateRendering extends TemplateRendering<object> {
  ...
  protected render(injector: Injector|undefined): EmbeddedViewRef<object> {
    return this.viewContainer.createEmbeddedView(this.template, {}, {injector});
  }

}

export class ConstantTemplateRendering<T extends object> extends TemplateRendering<T> {
...
export class TypedTemplateRendering<T extends object> extends TemplateRendering<T> {
...
export class ObservableTemplateRendering<T extends object> extends TemplateRendering<T> {
...
export namespace Rendering {
  ...
  export function Static(
    ...
    template: TemplateRef<object>|TemplateRef<void>
  ) {
    return new StaticTemplateRendering(viewContainer, template as TemplateRef<object>);
  }
   ...
   * @constructor
   */
  export function Constant<T extends object>(
    viewContainer: ViewContainerRef,
  ...
  export namespace FromSource {
     ...
     * @constructor
     */
    export function Constant<T extends object>(source: RenderSource<T>, data: T) {
     ...
     * @constructor
     */
    export function Typed<T extends object>(source: RenderSource<T>) {
     ...
     * @constructor
     */
    export function Observable<T extends object>(source: RenderSource<T>, data$: Observable<T>) {
