import {
  booleanAttribute, Directive, effect, ElementRef, EventEmitter, inject, input, InputSignal, InputSignalWithTransform,
  Output
} from '@angular/core';
...
export class NgxDropAreaDirective<T> {
  ...
  get dropEffectStr() {return this.dropEffect() ?? 'move'}
